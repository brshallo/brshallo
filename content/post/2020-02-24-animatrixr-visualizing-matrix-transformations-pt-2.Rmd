...
As with the last post, I'll describe trying to (very loosely) recreate a *small* part of the visualizations showing the geometry of matrix multiplication and changing basis vectors (using `gganimate` in R). 
