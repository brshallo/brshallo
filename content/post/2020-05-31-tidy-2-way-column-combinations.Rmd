...
At which point your data is in fundamentally the same form as shown in the prior code chunk (at least for if we only care about computing summary metrics that don't require vectors of equal length[^yourdata]) so you can move onto [II. Expand combinations].
