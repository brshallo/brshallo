...
Perhaps you want to calculate some measure of association between your new featurs and `Sale_price`. To keep things simple, I'm going to first remove any columns that contain any NA's or infinite values. I'll also use a random sample of just 1500 rows.
```{r}
