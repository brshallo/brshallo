...
Anyone who lives in a residential area in Seattle has likely seen [this](https://www.youtube.com/watch?v=0StcKgAWnu4), [this](https://www.youtube.com/watch?v=MdbA_Q8AEGA), or similar ads for residential solar installations. These elide that Seattle is a comparatively bad candidate for residential solar:
...
Determining whether to invest in residential solar panels is not about if it will break-even but on whether it offers greater returns and greenhouse gas reductions than other potential projects. -- i.e. you should consider the Opportunity Cost of the investment. 

Seattle gets ~2170 sunshine hours per year^[See [wikipedia's](https://en.wikipedia.org/wiki/List_of_cities_by_sunshine_duration) list of cities by sun duration.]. This is ~41% less than San Diego and ~78% less than Phoenix. Regions in the Northeast can also be better candidates for solar than Seattle. For example Boston, not known for it's sun, gets a large proportion of its energy from fossil fuels and has energy costs nearly double those in Seattle. Hence, for reasons different from the sunbelt, regions with high energy costs or a heavy reliance on fossil fuels may also be better prospects for solar than Seattle^[With a "smart grid" that was better able to transmit energy, you could have the sunbelt solar energy power the Northeast in which case unmet energy demands may be less pressing than optimizing on energy production.]. 

The stark differences in solar panel productivity and energy costs across different regions of the country suggests a pseudo-arbitrage opportunity. If the Seattle panels were installed in regions with more sun or greater energy demand, the panels could be more productive[^gaps]. I am oversimplifying[^details]; yet a closer examination of local electrical grids, panel productivity, etc. seems unlikely to lead to a conclusion that Seattleites should be putting solar panels on their roofs[^currently]... at least not while sunnier parts of the country and places with higher energy prices have excess space for panels and long wait lists for installations^[WARNING: I did not actually look much into whether these are true facts about the state of "prime" candidates for solar panel installations.]. Hence, if you are a climate conscious person living in Seattle with ~$30K sitting around, there are likely better options than your roof for investing in solar or other renewable energies[^but-why]. 

**Diversify your portfolio**

The typical American already has a disproportionate share of their wealth tied-up in their home. There is a certain logic to this centralization; people use and enjoy the space where they live -- remodeling your kitchen is *more* than just a capital investment in real estate. However you can't, in any substantive sense, use solar panels to add value to your day-to-day life[^exception]. Hence, most Americans should be slightly disinclined toward investments that further concentrate their portfolio of assets[^on-offer]. There are many ways to get involved in the solar industry that don't involve adding solar panels to your cloud-covered Seattle home. 
...
If Seattleites want to be a part of the growth of solar, they may be better off financing or investing in projects elsewhere. One idea might be to call your aunt in Southern California and offer to finance her panels[^payments]. Similarly, you could lease out the space on her roof and then buy and install your own panels[^leasing]. A problem with these sorts of arrangements is they get complicated when things change. What if she moves^[how do the contracts tie into the mortgage…?], the panels get damaged, someone stops paying someone, ...? These complexities are likely why solar panel financing is dominated by corporations and banks rather than peer-to-peer platforms. That rooftop leasing mostly doesn't exist in Seattle^[[Google Project Sunroof](https://sunroof.withgoogle.com/) suggests leasing out your roof is an option in Seattle but that the fees are greater than the returns.] is a tell that residential solar panel installations may not be as profitable (or at least as risk-free) as the mass of online ads make them sound[^in-cali]. 

Compared to trying to establish "remote" residential solar installations, ventures in solar farms/collectives/community owned panels are perhaps easier, lower risk options for an individual investor[^residential]. Solar farms are also more efficient than residential installs. Furthermore the minimum capital from each investor may be less than the price of a residential installation[^resident], thereby providing a path to invest for those who don't own their home or are unable to afford an installation on their personal residence. 

If one solar farm is good, many may be better^[Diversification is good!]. Rather than invest a stake in a single farm you could purchase equity in solar companies or bonds for solar operations that span many projects. There are also index funds that track solar power^[e.g.SUNIDX]. The global suite of financial services and investment markets are at our fingertips, exploring these in the context of the renewable energy industry can be an outlet for the *personal energy* of a Seattle solar-phile. 

**Individual action**

If your interest in solar is primarily wrapped-up in a goal to reduce your personal carbon footprint^[There's also the argument that you shouldn't try to offset your personal carbon footprint as much as you should just try to offset as much carbon as possible, regardless of your personal behavior.] you might instead purchase carbon offsets, donate to charities who focus on climate change, advocate to politicians to expand or open new renewable energy sources, or a myriad of other non-investment forms of engagement. When evaluating carbon conscious local home improvements you ought to take into account the comparative advantage associated with your region, home, or interests^[/How you spend your time.]. For example, heat pumps (which can replace a furnace and AC) work especially well in mild climates like Seattle's. If you have a spare bedroom or basement you might rent it out (higher density regions tend to contribute to lower per capita emissions). If your work involves driving, you might purchase an electric vehicle. I haven't run the numbers on any of these examples^[Depending on your local grid and situation it may be more effective to just purchase carbon offsets to reduce your footprint and hold-off on going electric.] but for any option you should...
...
1. compare it against both tangible (e.g. physical investments in your home) and non-tangible (e.g. stocks, bonds, donations) alternatives^[Both climate change and your investment portfolio are topics to be examined in a global context; it is important to consider the full range of options available to you and not get hung-up on thinking *just* in terms of your personal consumption or physical modifications you can make to your home.]

With a variety of green investment options available, it's important to maintain a shrewd perspective and choose the ones that optimize upon your targets[^action]. Investing in a cleaner future has never been easier or more important; I encourage you to take an active role in its development.

[^Anecdotal]: Touring around the city I regularly see residential solar installations. When I ask friends/family what they think about getting solar more of them say "I want to!" I didn't do a thorough review hence this statement is largely vibes based. I thought I heard installs were up ~20 percent year over year. However total installations are still a small fraction of what they are in California. What we *do* get a ton of in Seattle is ads for solar installations. 
...
[^but-why]: I won't focus so much on why residents choose to install solar in Seattle -- this post is more "hot take" than vigorous review. Some guesses for explanations: effective marketing by installers, generous incentives, wealthy/credulous/virtue signaling home owners, survivalist home owners, or, quite likely, I am missing something…
