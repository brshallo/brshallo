...
```{r collect-overall-performance, echo = FALSE}
...
```{r extract-performance-each-split, echo = FALSE}
...
We could use a paired sample t-test to provide a formally compare the random forest and linear models out-of-sample RMSE performance.
