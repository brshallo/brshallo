...
And code to tune a `ranger` Random Forest model, tuning the `mtry` and `min_n` parameters^[This was taking a *long* time and is part of why I decided to move the tuned examples to teh [Appendix].].
```{r, eval = FALSE}
