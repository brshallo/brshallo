...
I also recommend Dan's post on [Quantile regression forests](https://saattrupdan.github.io/2020-04-05-quantile-regression-forests/) for a description of *how* tree-based methods may be used to generate predictions for quantiles (which is rather intuitive).
...
This is even more surprising in the context of the [Performance] indicator of our model for overfitting. See [Residual Plots] in the [Appendix] for a few additional figures and notes. In the future I may investigate the reason for this more closely, for now I simply opened a [question on Cross Validated](https://stackoverflow.com/questions/66666257/prediction-intervals-from-quantile-regression-forests-have-higher-coverage-than).
...
Hopefully people on [Cross Validated]((https://stackoverflow.com/questions/66666257/prediction-intervals-from-quantile-regression-forests-have-higher-coverage-than)) know more...
