...
Drawing a line perpendicular to the base splits our Magna-Tile into two congruent triangles. Given the trigonemtric identity that $sin(\theta) = \frac{opposite}{hypotenuse}$ and that the hypotenuse of each triangle was set at 1 unit, we can calculate the length of the base of the Magna-Tile is *2sin(15&deg;).*
