...
The greater range in color hue for make-it-take-it settings demonstrates how, as you deviate from balanced shooting percentage conditions, shot imbalance grows more quickly than when playing with alternating possession after scores. This is why the 45%; 30% standard shooting percentage points in the upper right and lower left charts, while being quite different in terms of distance from "perfect balance" are pretty similar in terms of proportion imbalanced. 
