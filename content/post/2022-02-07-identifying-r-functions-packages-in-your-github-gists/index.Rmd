...
A problem I bumped into was that most of Chelsea's gists don't actually have .R or .Rmd extensions so my approach skipped most of her snippets. I wanted to parse my own gists but ran into a related problem that most of my github gist code snippets are saved as .md files^[As I often use this output type when creating a [reprex](https://github.com/tidyverse/reprex).].
...
Kind of like `knitr::purl()` but for .md files^[Also posted function on [SO question](https://stackoverflow.com/a/71025744/9059865).].
