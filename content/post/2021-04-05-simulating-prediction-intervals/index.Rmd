...
* the uncertainty due to model estimation 
* the uncertainty due to the sample 
...
**To produce simulated prediction intervals in [Example], I apply the following steps:**
...
Reviewing our example offer from the [Part 1](https://www.bryanshalloway.com/2021/03/18/intuition-on-uncertainty-of-predictions-introduction-to-prediction-intervals/#review-prediction-intervals) post, we see a similar prediction interval to that specified by the analytic method:
