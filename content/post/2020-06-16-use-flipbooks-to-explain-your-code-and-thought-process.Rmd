...
I sometimes want to convert a flipbook into a gif, e.g. for sharing an example in a README or a snippet of a cool concept on social media. If you ignored my prior entreaty, this is a second reminder to stop and go read about `flipbookr`, which contains the `code_create_gif_flipbook()` function. Just look at the beautiful gif thumbnails of flipbooks on the [about page](https://evamaerey.github.io/flipbooks/about)!
