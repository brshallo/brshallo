---
title: Should you use an assignment / exercise as part of your hiring process for
  a Data Scientist?
...
I think each of these points is (at least to some extent) true. However I answered the question in the positive. I pasted my answer below (making minor edits for clarity) ^[Note that while I have participated in the hiring of a few data science roles I am by no means *seasoned* in hiring data scientists.]. 
...
>
>We evaluate the task more from the lens of being primarily a pass / fail activity (so just being fast and over achieving on the the activity doesn't get a ton of extra credit). We let the candidates pick their date / time and then expect them to submit within the timeframe.
>
...
>
>We have (usually) used presentations as part of the interview process as well (which are often extensions upon the technical activity), though I'm more ambivalent on the usefulness of these in terms of how well they differentiate candidates. Preparing for a presentation also means asking the candidates to invest substantially more time.
>
