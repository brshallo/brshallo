...
*Below I will describe the rules for such a game that I will call "Wallet Roulette"^[or "Russian Wallet Roulette" or some variation on this.]. The game is set-up to look and feel somewhat similar to slots but with a payout structure that is inverted to typical slots games (i.e. the player typically has small wins followed by occasional large losses^[However in the "Game Options" I provide ways by which a player could set their own risk levels (e.g. by filling their gun with more bullets). Hence I also envision the game having a bit more customizability compared to what is typical in slots.]).*
