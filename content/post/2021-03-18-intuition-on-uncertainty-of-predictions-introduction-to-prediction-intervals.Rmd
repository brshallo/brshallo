...
Measures like *coverage* and *interval width* are helpful for evaluating prediction intervals. These metrics will be used in follow-up posts on __Building Prediction Intervals Using Simulation__ and __Building Prediction Intervals Using Quantile Regression__, where I walk through more sophisticated and flexible methods for building prediction intervals.
