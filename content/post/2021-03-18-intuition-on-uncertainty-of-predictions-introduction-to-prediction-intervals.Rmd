...
This is the first of three posts on prediction intervals (__part 2__ employs quantile regression, and __part 3__ simulation techniques). I use the R programming language and the [tidyverse](https://www.tidyverse.org/) + [tidymodels](https://www.tidymodels.org/) suites of packages to create all models and figures.
...
The uncertainty described here corresponds with the *confidence intervals* and not quite as directly with the *prediction intervals* (the focus of this post). The distinction and relationship between these will be discussed in [A Few Things to Understand About Prediction Intervals].
