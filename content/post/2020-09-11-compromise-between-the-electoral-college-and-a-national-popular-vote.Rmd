...
* greater variability in outcomes compared to alternatives^[A few thousand votes in a few places have a greater chance of swaying entire elections in our current system compared to the likelihood of this occurring with a national popular vote.]
...
Aggregating these for the 2012 election, the Democrat (Obama) would have received 271.4 electoral votes, the Republican (Romney) 255 electoral votes, and other candidates 11.6 electoral votes. This represents 50.4%, 47.4%, and 2.2% respectively. Describing outcomes in terms of 'proportional allocation of electoral votes' or as a 'weighted percentage of the popular vote' are interchangeable^[As long as you allow for fractional electoral votes.]. However percentages are easier to articulate, hence that is the terminology I use for the remainder of the post.
...
See github repo [brshallo/weighted-national-popular-vote](https://github.com/brshallo/weighted-national-popular-vote) for details on data sources and scripts used to produce figures.
...
The chief advantage of a national popular vote for presidential elections is not that it achieves *perfect* representation but that it provides *improved incentives* for presidential candidates. For example it would promote campaigns and policy proposals that gave attention to a broader subset of the American public^[As described [here]( https://www.nationalpopularvote.com/written-explanation).] and reduce the variability in election results. However a national popular vote inevitably faces partisan challenges and may give-off the appearance of being too momentous a departure from the norms of the existing electoral college. As a compromise between these systems, a national popular vote, that is weighted by the electoral college, avoids many of the challenges to legislating a pure national popular vote while still achieving its most important objectives.
